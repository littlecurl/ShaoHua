package cn.edu.heuet.shaohua.constant;
...
public class NetConstant {
    ...
    private static final String getNewsListURL = baseService + "/news/list";

    private static final String getNewsByIdURL = baseService + "/news/detail/id?id=";

    private static final String getNewsByTitleURL = baseService + "/news/detail/title?title=";
